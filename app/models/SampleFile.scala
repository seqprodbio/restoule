...
case class SampleFile(id: Option[Int], fileName: String, path: String, origin: String, createdInDB: java.sql.Date)
...
class SampleFileTable(tag: Tag) extends Table[SampleFile](tag, "sample_file") {
   ...
   def createdInDB = column[java.sql.Date]("created_date", O.NotNull)
