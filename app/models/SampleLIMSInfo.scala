...
case class SampleLIMSInfo(id: Option[Int], libraryName: String, donor: String, libraryStrategy: String, librarySource: String, librarySelection: String)
...
class SampleLIMSInfoTable(tag: Tag) extends Table[SampleLIMSInfo](tag, "sample_lims_info") {
   ...
   def * = (id.?, libraryName, donor, libraryStrategy, librarySource, librarySelection) <> (SampleLIMSInfo.tupled, SampleLIMSInfo.unapply)
}