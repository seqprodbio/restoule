...
create table "ftp_credentials" ("id" SERIAL NOT NULL PRIMARY KEY,"ftp_site" VARCHAR(254) NOT NULL,"username" VARCHAR(254) NOT NULL,"password" VARCHAR(254) NOT NULL,"created_date" DATE NOT NULL);
create table "local_dir" ("id" SERIAL NOT NULL PRIMARY KEY,"path" VARCHAR(254) NOT NULL,"created_date" DATE NOT NULL);
...
create table "sample_file" ("id" SERIAL NOT NULL PRIMARY KEY,"filename" VARCHAR(254) NOT NULL,"path" VARCHAR(254) NOT NULL,"origin" VARCHAR(254) NOT NULL,"created_date" DATE NOT NULL);
