...
create table "sample_lims_info" ("id" SERIAL NOT NULL PRIMARY KEY,"library_name" VARCHAR(254) NOT NULL,"donor" VARCHAR(254) NOT NULL,"library_strategy" VARCHAR(254) NOT NULL,"library_source" VARCHAR(254) NOT NULL,"library_selection" VARCHAR(254) NOT NULL);
